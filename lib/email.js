...
// 发件人地址。EMAIL_FROM 里的域名必须是「生产 RESEND_API_KEY 所属账号」下已 verified 的域名，
// 否则 Resend 会返回 403 domain is not verified。可在 Vercel 环境变量里覆盖，无需改代码。
const FROM = env('EMAIL_FROM') || 'WC2026 AI 助手 <noreply@wc2026-ai.top>';
