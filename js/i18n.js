...
const ZH = {
  ...
  // 顶部导航 (2026-07-08 精简: 12 项 → 6 项 + 1 下拉)
  'nav.home': '首页',
  'nav.matches': '赛程',
  ...
  // 阶段（约定：1/N 决赛 = N 队出场，比如 1/16 决赛 = 16 强 = Round of 16）
  'stage.group': '小组赛',
  'stage.r32': '32 强',
  'stage.r16': '1/16 决赛',
  'stage.qf': '1/8 决赛',
  ...
  'home.hero.title1': '世界杯博彩直觉，',
  'home.hero.title2': '真的成立吗？',
  'home.hero.title3': '用回测说话',
  'home.hero.body': '48 支球队 · 104 场比赛。我用 2022 全程 + 2026 在赛的真实赔率与赛果做回测，诚实地论证或证伪常见博彩直觉；同时记录各大 AI 大模型的赛前预测、赛后对账。不卖必胜，只讲数据与机制。',
  'home.hero.cta0': '▶ 回测实验室',
  'home.hero.cta2': '⭐ AI 预测',
  'home.hero.cta3': '赛程 · 积分 · 比分 →',
  ...
  'about.title': '关于这个站点',
  'about.goal.title': '🎯 目的',
  'about.goal.body': '这是一个静态站点，把 2026 美加墨世界杯的赛程、比分，跟我赛前问各大 AI 大模型的预测记录放在一起对比。世界杯正在进行中，每场比赛结束后我都会更新比分和命中情况。',
  'about.experiment.title': '🧪 实验设计',
  'about.experiment.li1': '每场比赛开赛前 24 小时内，用<b>同一个 prompt</b>（见每场 AI 预测页）分别问下面 5 个大模型。',
  'about.experiment.li2': '比赛结束后，更新比分 → 系统自动判定每个模型是 ✅ 比分命中 / ⚠️ 胜负命中 / ❌ 未中。',
  'about.experiment.li3': '随着赛事推进，统计页会实时刷新每个模型的累计战绩；全部结束后给出最终排名。',
  'about.models.title': '🤖 对比的 AI 模型',
  'about.models.body': '本届固定对比 <b>5</b> 个大模型：<b>MiniMax-M3</b>、<b>Claude Opus 4.8</b>、<b>GPT-5 mini</b>、<b>DeepSeek-V4</b>、<b>Kimi</b>。每场赛前用同一 prompt 各问一次，赛后统一对账。',
  'about.assistant.title': '💬 站内 AI 助手',
  'about.assistant.body': '页面右下角的浮窗是本站的 <b>世界杯 AI 助手</b>，它结合本站赔率库 + 回测研究 + 实时联网来回答问题：<br>· <b>赔率分析</b>：胜平负 / 让球 / 比分 / 总进球<br>· <b>回测解读</b>：基于赔率纠偏模型与历史回测，解读赔率结构与机制（不提供投注推荐）<br>· <b>联网信息</b>：伤停、首发、突发新闻<br>用邮箱收验证码即可登录，新用户自动送 3 次免费提问、无需密码；非世界杯相关问题会礼貌拒绝。',
  ...
  'about.disclaimer.body': '本站所有 AI 预测内容仅代表大模型当时的输出，不代表任何事实或建议。比分和 AI 预测由我手动录入，请勿用作任何决策依据。<b>本站只卖研究数据与工具，不构成任何投注建议</b>；不鼓励、不引导任何形式的博彩行为；竞彩有风险，未满 18 周岁请勿参与。',
  ...
  'meta.home.title': 'WC 2026 · 世界杯回测研究 + AI 预测对账',
  'meta.home.description': '用 2022 全程 + 2026 真实赔率与赛果回测，诚实论证世界杯博彩直觉；并记录多 AI 大模型赛前预测与命中统计。不卖必胜，只讲数据与机制。',
  ...
  'meta.frequency.title': '频率图谱 · WC 2026 · AI 预测',
  'meta.frequency.description': '5 类玩法的真实赛果频率分布：胜平负 / 让球 / 比分 / 总进球 / 半全场，2026 在赛 + 2022 全程并排对照。',
  'meta.lab.title': '回测实验室 · WC 2026 · 用真金白银验证',
  'meta.lab.description': '用 2022 + 2026 真赔率 + 真赛果跑回测，6 个预设卡 + 自由配置（玩法/方向/结构/串关），告诉你每条策略的 ROI 和最大回撤。',
  ...
  // 频率图谱页
  'frequency.masthead.title': 'FREQUENCY ATLAS',
  'frequency.masthead.sub': '5 玩法真实赛果分布 · 2026 在赛 + 2022 全程',
  'frequency.masthead.source': '数据来源：竞彩网 sporttery.cn',
  'frequency.masthead.updLabel': '更新时间：',
  'frequency.masthead.note': '完赛即刷新 · 频率 = 真实命中 / 该玩法已完赛场次',
  'frequency.year2026': '2026 美加墨世界杯 · IN PROGRESS',
  'frequency.year2022': '2022 卡塔尔世界杯 · REFERENCE',
  'frequency.loading': '加载中…',
  'frequency.footer.note': '仅世界杯正赛 · 完赛即重新生成',
  'frequency.play.spf': '胜平负',
  'frequency.play.spfEn': 'Win-Draw-Lose',
  'frequency.play.rqspf': '让球胜平负',
  'frequency.play.rqspfEn': 'Asian Handicap',
  'frequency.play.bf': '比分',
  'frequency.play.bfEn': 'Score Distribution',
  'frequency.play.zjq': '总进球',
  'frequency.play.zjqEn': 'Total Goals',
  'frequency.play.bqc': '半全场',
  'frequency.play.bqcEn': 'Half-Time / Full-Time',

  // Backtest lab page
  'lab.masthead.title': 'BACKTEST LAB',
  'lab.masthead.sub': '2022 + 2026 真赔率重放 · 每注 1 元 · 90 分钟口径结算',
  'lab.masthead.source': '数据来源：竞彩网 sporttery.cn',
  'lab.masthead.updLabel': '数据集生成：',
  'lab.masthead.note': '不是预测，是历史重放',
  'lab.ctrl.play': '玩法',
  'lab.ctrl.pick': '方向',
  'lab.ctrl.stage': '阶段',
  'lab.ctrl.rounds': '小组轮次 (R1/R2/R3)',
  'lab.ctrl.spread': '让球赔差 ≥',
  'lab.ctrl.scenario': '小组情景 (R2/R3)',
  'lab.ctrl.struct': '结构',
  'lab.ctrl.run': '▶ 跑回测（免费）',
  'lab.opt.all': '全部',
  'lab.opt.group': '小组',
  'lab.opt.ko': '淘汰',
  'lab.opt.single': '单关',
  'lab.opt.parlay2': '2 串 1',
  'lab.opt.parlay3': '3 串 1',
  'lab.opt.cover': '覆盖 (双选)',
  'lab.opt.scenario.all': '全部情景',
  'lab.opt.scenario.rest_vs_out': '养生局 (出 vs 出)',
  'lab.opt.scenario.rest_vs_mid': '养生 vs 中游',
  'lab.opt.scenario.same_pts_battle': '同分搏出线',
  'lab.opt.scenario.win_vs_loss': '赢 vs 输',
  'lab.opt.scenario.both_lost_r2': '双败 R2',
  'lab.opt.scenario.other_r2': '其它 R2',
  'lab.opt.scenario.other_r3': '其它 R3',
  'lab.result.empty': '选个预设卡或调好配置，点「跑回测」',
  'lab.result.err': '计算失败',
  'lab.result.dropped': '尾腿已弃用：2022 弃 {n1} 腿 / 2026 弃 {n2} 腿（凑不满 {k} 串一注）',
  'lab.ai.cta': '🧠 AI 解读（5 credits）',
  'lab.ai.loading': '⏳ AI 解读中（5 credits）…',
  'lab.ai.error.network': '⚠ 网络错误',
  'lab.ai.error.402': '⚠ 积分不足，请先兑换 license key。',
  'lab.ai.error.401': '⚠ 请先登录',
  'lab.ai.error.other': '⚠ AI 解读失败',
  'lab.export.cta': '⬇ CSV 明细（1 credit）',
  'lab.export.hint': '导出 {n} 票明细',

  // matches.html 顶部 segmented control
  'matches.tab.schedule': '赛程',
  'matches.tab.standings': '积分榜',
  'matches.tab.results': '比分',
  'matches.pageTitle': '赛程 · 积分榜 · 比分',
  'matches.pageSub': '2026 美加墨世界杯的赛程时间表 / 小组积分表 / 已完赛比分表，单页切换。',
  'lab.honest.title': '诚实刹车 · 4 条必须知道',
  'lab.honest.l1.t': '历史不代表未来：',
  'lab.honest.l1.v': '2022 强 + 2026 强 = 两次样本，不代表 2030 仍如此。市场规模、伤停、状态、天气都不在数据里。',
  'lab.honest.l2.t': '赔率含水：',
  'lab.honest.l2.v': '竞彩网平均 8-12% 抽水（"退水"），单关想长期正 ROI 必须战胜这条基线。投三门也只输不赢。',
  'lab.honest.l3.t': '样本量警示：',
  'lab.honest.l3.v': '小组赛 R3 全 WC 共 ~16 场，过滤后会 < 5 场。n < 10 的结论请当提示而非铁律。',
  'lab.honest.l4.t': '90 分钟口径：',
  'lab.honest.l4.v': '加时 / 点球不算入胜平负 / 让球 / 进球；比分只算常规时间。',
  'lab.footer.note': '不构成投注建议 · 90 分钟口径结算 · 1 注 = 1 元',
};
...
const EN = {
  ...
  'nav.stats': 'Stats',
  'nav.lab': 'Backtest Lab',
  'nav.teams': 'Teams',
  'nav.more': 'More',
  'nav.frequency': 'Frequency',
  'nav.pricing': 'Pricing',
  'nav.bets': 'Bet Simulator',
  'nav.about': 'About',
  'nav.contact': 'Contact',
  'nav.fifa': 'FIFA',
  'nav.login': 'Sign in',
  ...
  'home.hero.title1': 'Do betting hunches ',
  'home.hero.title2': 'actually hold up?',
  'home.hero.title3': 'Let backtests decide',
  'home.hero.body': '48 teams · 104 matches. Using real odds and results from the full 2022 tournament plus 2026 so far, I honestly test — and often debunk — common betting intuitions, while also tracking pre-match predictions from major AI models. No sure things, just data and mechanisms.',
  'home.hero.cta0': '▶ Backtest Lab',
  'home.hero.cta2': '⭐ AI Predictions',
  'home.hero.cta3': 'Schedule · Standings · Results →',
  'home.today.kicker': 'Today',
  ...
  'home.cards.schedule.title': 'Schedule · Standings · Results',
  'home.cards.schedule.desc': '104 matches + 12 groups + settled',
  'home.cards.standings.title': 'Group standings',
  ...
  'about.goal.body': 'A static site that puts the 2026 World Cup schedule & scores next to my pre-match AI model predictions. The tournament is underway; after every match I update the score and hit/miss status.',
  'about.experiment.title': '🧪 Experimental design',
  'about.experiment.li1': 'Within 24 hours before kickoff, ask the <b>same prompt</b> (see each match\'s AI prediction page) to the 5 models below.',
  ...
  'about.experiment.li3': 'As the tournament progresses the Stats page refreshes each model\'s running record; final rankings appear once everything concludes.',
  'about.models.title': '🤖 AI models compared',
  'about.models.body': 'Five models compared this tournament: <b>MiniMax-M3</b>, <b>Claude Opus 4.8</b>, <b>GPT-5 mini</b>, <b>DeepSeek-V4</b>, <b>Kimi</b>. Each is asked the same prompt before every match and reconciled afterward.',
  'about.assistant.title': '💬 On-site AI assistant',
  'about.assistant.body': 'The floating widget at the bottom-right is this site\'s <b>World Cup AI assistant</b>. It answers using the site\'s odds database + backtest research + live web search:<br>· <b>Odds analysis</b>: 1X2 / handicap / correct score / total goals<br>· <b>Backtest readouts</b>: interprets odds structure and mechanisms from the odds-correction model and historical backtests (no betting tips)<br>· <b>Live info</b>: injuries, lineups, breaking news<br>Sign in with an email code — new users get 3 free questions, no password. Non–World Cup questions are politely declined.',
  ...
  'about.disclaimer.body': 'All AI prediction content reflects the model\'s output at the time and is not advice. Scores and predictions are entered manually; please do not use them as a basis for any decision. <b>This site sells research data and tools only and does not constitute betting advice</b>; it does not encourage any form of gambling. Gambling carries risk; please do not participate if you are under 18.',
  ...
  'meta.home.title': 'WC 2026 · Backtest Research + AI Prediction Tracking',
  'meta.home.description': 'Honest backtests of World Cup betting intuitions using real 2022 + 2026 odds and results, plus multi-model AI prediction tracking. No sure things — just data and mechanisms.',
  ...
  'meta.frequency.title': 'Frequency Atlas · WC 2026',
  'meta.frequency.description': 'Real result frequency distribution across 5 markets: 1X2 / Handicap / Correct Score / Total Goals / HT-FT, side by side for 2026 in progress + 2022 full tournament.',
  'meta.lab.title': 'Backtest Lab · WC 2026',
  'meta.lab.description': 'Replay 2022 + 2026 with real odds and real results. 6 preset cards + free config (market / pick / structure / parlay) — see ROI and max drawdown for every strategy.',
  ...
  // Frequency atlas page
  'frequency.masthead.title': 'FREQUENCY ATLAS',
  'frequency.masthead.sub': 'Real distribution of 5 markets · 2026 in progress + 2022 full',
  'frequency.masthead.source': 'Source: sporttery.cn',
  'frequency.masthead.updLabel': 'Updated: ',
  'frequency.masthead.note': 'Refreshed per match · Frequency = actual hit / finished matches of that market',
  'frequency.year2026': '2026 FIFA World Cup · IN PROGRESS',
  'frequency.year2022': '2022 FIFA World Cup · REFERENCE',
  'frequency.loading': 'Loading…',
  'frequency.footer.note': 'World Cup main stage only · rebuilt on every match completion',
  'frequency.play.spf': 'Win-Draw-Lose',
  'frequency.play.spfEn': 'Match Result',
  'frequency.play.rqspf': 'Handicap',
  'frequency.play.rqspfEn': 'Asian Handicap',
  'frequency.play.bf': 'Correct Score',
  'frequency.play.bfEn': 'Score Distribution',
  'frequency.play.zjq': 'Total Goals',
  'frequency.play.zjqEn': 'Over / Under Buckets',
  'frequency.play.bqc': 'Half-Time / Full-Time',
  'frequency.play.bqcEn': 'HT / FT Combinations',

  // Backtest lab page
  'lab.masthead.title': 'BACKTEST LAB',
  'lab.masthead.sub': 'Replay 2022 + 2026 with real odds · 1 unit per bet · 90-min settlement',
  'lab.masthead.source': 'Source: sporttery.cn',
  'lab.masthead.updLabel': 'Dataset: ',
  'lab.masthead.note': 'Not a prediction — a historical replay',
  'lab.ctrl.play': 'Market',
  'lab.ctrl.pick': 'Pick',
  'lab.ctrl.stage': 'Stage',
  'lab.ctrl.rounds': 'Group Rounds (R1/R2/R3)',
  'lab.ctrl.spread': 'Handicap spread ≥',
  'lab.ctrl.scenario': 'Group scenario (R2/R3)',
  'lab.ctrl.struct': 'Structure',
  'lab.ctrl.run': '▶ Run backtest (free)',
  'lab.opt.all': 'All',
  'lab.opt.group': 'Group',
  'lab.opt.ko': 'Knockout',
  'lab.opt.single': 'Single',
  'lab.opt.parlay2': '2-leg parlay',
  'lab.opt.parlay3': '3-leg parlay',
  'lab.opt.cover': 'Cover (2 picks)',
  'lab.opt.scenario.all': 'All scenarios',
  'lab.opt.scenario.rest_vs_out': 'Rest vs out',
  'lab.opt.scenario.rest_vs_mid': 'Rest vs mid',
  'lab.opt.scenario.same_pts_battle': 'Same-pts battle',
  'lab.opt.scenario.win_vs_loss': 'Win vs loss',
  'lab.opt.scenario.both_lost_r2': 'Both lost R2',
  'lab.opt.scenario.other_r2': 'Other R2',
  'lab.opt.scenario.other_r3': 'Other R3',
  'lab.result.empty': 'Pick a preset card or tune config, then click Run',
  'lab.result.err': 'Computation failed',
  'lab.result.dropped': 'Tail legs dropped: 2022 dropped {n1} / 2026 dropped {n2} (cannot fill a {k}-leg parlay)',
  'lab.ai.cta': '🧠 AI interpretation (5 credits)',
  'lab.ai.loading': '⏳ AI interpreting (5 credits)…',
  'lab.ai.error.network': '⚠ Network error',
  'lab.ai.error.402': '⚠ Insufficient credits. Please redeem a license key.',
  'lab.ai.error.401': '⚠ Please sign in first',
  'lab.ai.error.other': '⚠ AI failed',
  'lab.export.cta': '⬇ CSV details (1 credit)',
  'lab.export.hint': 'Export {n} ticket details',

  // matches.html top segmented control
  'matches.tab.schedule': 'Schedule',
  'matches.tab.standings': 'Standings',
  'matches.tab.results': 'Results',
  'matches.pageTitle': 'Schedule · Standings · Results',
  'matches.pageSub': '2026 World Cup match schedule, group standings, and final scores — single page, three views.',
  'lab.honest.title': 'Honest brake · 4 things you must know',
  'lab.honest.l1.t': 'Past ≠ future: ',
  'lab.honest.l1.v': 'Two good samples do not make a third. Market size, injuries, form, weather — none are in the data.',
  'lab.honest.l2.t': 'Vigorish is real: ',
  'lab.honest.l2.v': 'sporttery.cn charges 8–12% vig. To stay green long-term you must beat that baseline. Betting all three outcomes still loses.',
  'lab.honest.l3.t': 'Sample size warning: ',
  'lab.honest.l3.v': 'A whole-WC Group R3 has only ~16 matches. After filters, that drops below 5. Treat n < 10 as a hint, not a rule.',
  'lab.honest.l4.t': '90-minute settlement: ',
  'lab.honest.l4.v': 'Extra time / penalties do NOT count for 1X2 / Handicap / Total Goals. Score markets settle on regular time.',
  'lab.footer.note': 'Not betting advice · 90-min settlement · 1 unit = 1 unit',
};
