...
const ZH = {
  ...
  'about.assistant.body': '页面右下角的浮窗是本站的 <b>世界杯 AI 助手</b>，它结合本站赔率库 + 建模推荐 + 实时联网来回答问题：<br>· <b>赔率分析</b>：胜平负 / 让球 / 比分 / 总进球<br>· <b>建模推荐</b>：基于 R-013 / R-031 已验证策略，按需生成每日推荐单<br>· <b>联网信息</b>：伤停、首发、突发新闻<br>用邮箱收验证码即可登录，新用户自动送 3 次免费提问、无需密码；非世界杯相关问题会礼貌拒绝。',
...
const EN = {
  ...
  'about.assistant.body': 'The floating widget at the bottom-right is this site\'s <b>World Cup AI assistant</b>. It answers using the site\'s odds database + modeling picks + live web search:<br>· <b>Odds analysis</b>: 1X2 / handicap / correct score / total goals<br>· <b>Modeling picks</b>: daily recommendations based on the validated R-013 / R-031 strategies<br>· <b>Live info</b>: injuries, lineups, breaking news<br>Sign in with an email code — new users get 3 free questions, no password. Non–World Cup questions are politely declined.',
