...
const ZH = {
  ...
  'about.bets.body': '另开了一个 <a class="text-ink font-bold hover:text-gold" href="/bets.html">足彩模拟专栏</a>，把「按 1000 元预算、每倍 2 元玩世界杯冠军盘，会怎么选、怎么结算」做成纯虚构的<a class="text-ink font-bold hover:text-gold" href="/bets.html">沙盘推演</a>，并随赛事进程持续更新。<b>所有金额、倍数、选项、命中结果均为站长编造的模拟数据</b>，与任何真实投注无关。',
...
const EN = {
  ...
  'about.bets.body': 'A separate <a class="text-ink font-bold hover:text-gold" href="/bets.html">Bets Simulation</a> column models "with a 1000-yuan budget at 2 yuan per unit on the World Cup champion market, what would I pick and how would it settle" as a fictional sandbox, updated as the tournament unfolds. <b>All amounts, multipliers, picks and outcomes are fictional data authored by the site owner</b> and unrelated to any real betting.',
